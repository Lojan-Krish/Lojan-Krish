...
![Selected work: BBK attendance platform, SmartMed, Support Our Schools](work.svg)

<details>
<summary><b>BBK Sri Lanka — employee attendance &amp; shift platform</b> · Python · FastAPI · PostgreSQL · React · Azure · Docker</summary>
...
<details>
<summary><b>Support Our Schools — Sri Lanka Map plugin</b> · PHP · MySQL · REST API · PWA · i18n</summary>
...
90+ Google PageSpeed on every one. Load times down from over 8 seconds to under 2. A client rebuild came in 60% faster with 20% lower bounce, and organic search visibility up 150%.
